...
var taskInput=document.querySelector(".task-wrapper__new-task");//Add a new task.
...
var createNewTaskElement=function(taskString){
    ...
    label.className="label task new-task__subtitle";

    //Each elements, needs appending
    checkBox.type="checkbox";
    checkBox.className="item__checkbox item_checkbox";
    editInput.type="text";
